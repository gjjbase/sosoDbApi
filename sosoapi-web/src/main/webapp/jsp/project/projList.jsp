                       		...
                       		<div class="panel-heading">
                           		...
                           		<div class="button-groups pull-right">
                           			<div class="btn-group">
										...
										<a href="javascript:void(0);" onclick="inits()" data-toggle="modal" class="text-muted">
											<i class="fa fa-plus"></i> 初始化
										</a>
										<script>
											//初始操作
											function inits(){
												bootbox.confirm("确定执行API初始化操作？",function(){

													doPost("auth/proj/init.htm",null,function(data){
														notice(data,function(){
															location.reload();
														});
													});
												});
